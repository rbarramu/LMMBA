...
<html>
    ...
    <body>
        ...
        <div id="show-cargo" class="content scaffold-show" role="main">
            ...
            <f:display bean="cargo" />
            <g:form resource="${this.cargo}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.cargo}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
